...
static PyObject *__pyx_pw_10helloworld_1primes(PyObject *__pyx_self, PyObject *__pyx_arg_nb_primes) {
  ...
  assert(__pyx_arg_nb_primes); {
    __pyx_v_nb_primes = __Pyx_PyInt_As_int(__pyx_arg_nb_primes); if (unlikely((__pyx_v_nb_primes == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 6, __pyx_L3_error)
  }
 ...
 */
  ...
  for (__pyx_t_4 = __pyx_v_p; __pyx_t_4 < __pyx_t_3; __pyx_t_4++) {
    ...
    __pyx_t_6 = __Pyx_PyInt_From_int(__pyx_v_prime); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 31, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    if (unlikely(__Pyx_ListComp_Append(__pyx_t_5, (PyObject*)__pyx_t_6))) __PYX_ERR(0, 31, __pyx_L1_error)
 ...
 *     cdef int[1000] p
 */
  __pyx_tuple_ = PyTuple_Pack(8, __pyx_n_s_nb_primes, __pyx_n_s_nb_primes, __pyx_n_s_n, __pyx_n_s_i, __pyx_n_s_len_p, __pyx_n_s_p, __pyx_n_s_result_as_list, __pyx_n_s_prime); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple_);
  __Pyx_GIVEREF(__pyx_tuple_);
  __pyx_codeobj__2 = (PyObject*)__Pyx_PyCode_New(1, 0, 8, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple_, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_helloworld_pyx, __pyx_n_s_primes, 6, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__2)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
 ...
 *     cdef int[1000] p
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_10helloworld_1primes, NULL, __pyx_n_s_helloworld); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 6, __pyx_L1_error)
